...
namespace RimRound.UI
{
    ...
    public class ITab_Perks : ITab
    {
        ...
        public override void FillTab()
        {
            ...
            Rect descriptionRect = new(titleRect.x, titleRect.yMax, basePawnCardSize.x, basePawnCardSize.y - heightOfTitleRect);
        ...
        private Rect DrawUpperSection(Rect titleRect) 
        {
            ...
            Vector2 barOffset = new(0, 35);
            Vector2 barSize = new(230, 20);
            Rect fillableBarRect = new(titleRect.x + barOffset.x, titleRect.y + barOffset.y, barSize.x, barSize.y);
            ...
            Rect barLabelRect = new(fillableBarRect);
        ...
        private void DrawPerks(Rect drawRect) 
        {
            ...
            Rect basictitleRect = new(drawRect.x, drawRect.y + titleOffset + Mathf.FloorToInt(perkIndex/3) * verticalSpaceBetweenIcons, drawRect.width, Text.CalcSize("RR_Basic_Perks_Title".Translate().Truncate(drawRect.width)).y);
            Text.Font = GameFont.Small;
            ...
            Text.Font = GameFont.Medium;
            Rect advancedTitleRect = new(drawRect.x, drawRect.y + titleOffset + Mathf.FloorToInt(perkIndex/3) * verticalSpaceBetweenIcons, drawRect.width, Text.CalcSize("RR_Basic_Perks_Title".Translate().Truncate(drawRect.width)).y);
            Text.Font = GameFont.Small;
            ...
            Text.Font = GameFont.Medium;
            Rect eliteTitleRect = new(drawRect.x, drawRect.y + titleOffset + Mathf.FloorToInt(perkIndex/3) * verticalSpaceBetweenIcons, drawRect.width, Text.CalcSize("RR_Basic_Perks_Title".Translate().Truncate(drawRect.width)).y);
            Text.Font = GameFont.Small;
            ...
            Text.Font = GameFont.Medium;
            Rect ultraTitleRect = new(drawRect.x, drawRect.y + titleOffset + Mathf.FloorToInt(perkIndex/3) * verticalSpaceBetweenIcons, drawRect.width, Text.CalcSize("RR_Basic_Perks_Title".Translate().Truncate(drawRect.width)).y);
            Text.Font = GameFont.Small;
            ...
            Text.Font = GameFont.Medium;
            Rect abilitiesTitleRect = new(drawRect.x, drawRect.y + titleOffset + Mathf.FloorToInt(perkIndex/3) * verticalSpaceBetweenIcons, drawRect.width, Text.CalcSize("RR_Basic_Perks_Title".Translate().Truncate(drawRect.width)).y);
            Text.Font = GameFont.Small;
        ...
        private void DrawSinglePerk(Perk perk, int entryIndex, Rect drawInRect, FullnessAndDietStats_ThingComp comp) 
        {
            ...
            Rect labelRect = new(drawRect.x - (textLength - imageWidth) / 2, drawRect.y - textOffset, totalWidthForEntry, Text.CalcSize(textTitle).y);
        ...
        private Rect CalculateSizeOfPerksContainingRect(Rect containingRect, int numberOfPerkIcons, Vector2 sizeOfEachIconArea) 
        {
            ...
            Rect resultRect = new(containingRect);
        ...
        private Vector2 scrollbarPos = new();

        public static Vector2 basePawnCardSize = new(480f, 455f);
