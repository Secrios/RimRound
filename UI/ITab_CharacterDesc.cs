...
namespace RimRound.UI
{
    internal class ITab_CharacterDesc : ITab
    {
        ...
        public override void FillTab()
        {
			...
			Rect descriptionRect = new(titleRect);
		...
		void DrawCharacterDescription(Rect rect) 
		{
			if (PawnToShowInfoAbout is Pawn pawn)
			{
				...
				Rect textrect = new(rect.x, rect.y, rect.width, rect.height);
		...
		static Dictionary<float, string> femaleBodyTypeDescriptions = new() 
		{							   
		...
		static Dictionary<float, string> maleBodyTypeDescriptions = new()
		{
		...
		static Dictionary<float, string> descriptionTitles = new()
		{
		...
		static Dictionary<float, string> ratkinExtraDescriptions = new()
		{
