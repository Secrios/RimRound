...
namespace RimRound.UI
{
    public class MainTabWindow_RRGlobalSettings : MainTabWindow
    {
        ...
        private void DoNumericHediffSettings(Rect inRect) 
        {
            ...
            Rect globalMultipliersSettingsTitleRect = new(0, 50, 600, Text.LineHeight);
            Widgets.Label(globalMultipliersSettingsTitleRect, "RR_Hsw_HediffNumericSettings_SettingsTitle".Translate());

            Rect globalMultipliersSettingsFieldRect = new(0, globalMultipliersSettingsTitleRect.yMax, globalMultipliersSettingsTitleRect.width, 200);
        ...
        {
            Text.Font = GameFont.Medium;
            Rect titleRect = new(inRect.x, inRect.y + 45f, inRect.width, 2 * Text.LineHeight);
            DoMainSettingsTitleGroup(titleRect);

            Rect nutritionSettingsGroup = new(inRect.x, titleRect.yMax, windowWidth / 3, 0);
            //DoNutritionSettingsGroup(nutritionSettingsGroup);

            Rect globalMultipliersSettingsGroup = new(nutritionSettingsGroup.x, nutritionSettingsGroup.yMax, nutritionSettingsGroup.width, windowHeight);
            DoGlobalMultpliersSettingsGroup(globalMultipliersSettingsGroup);

            Rect exemptionSettingsGroup = new(0.33333f * inRect.width, titleRect.yMax, 0.33333f * inRect.width, 200);
            DoExemptionSettingsGroup(exemptionSettingsGroup);

            Rect generalSettingsRect = new(exemptionSettingsGroup.x, exemptionSettingsGroup.yMax, exemptionSettingsGroup.width, exemptionSettingsGroup.height + 200);
            DoGeneralSettingsGroup(generalSettingsRect);

            Rect gizmoSettingsGroupRect = new(0.66666f * inRect.width, titleRect.yMax, 0.33333f * inRect.width, inRect.height - titleRect.height);
        ...
        private void DoGizmoSettingsGroup(Rect gizmoSettingsGroup)
        {
            ...
            Text.Font = GameFont.Medium;
            Rect gizmoSettingsTitleRect = new(0, 0, gizmoSettingsGroup.width, Text.LineHeight);
            Widgets.Label(gizmoSettingsTitleRect, "RR_Mtw_GizmoSettingsTitle".Translate());


            Rect gizmoSettingsCheckBoxesRect = new(0, gizmoSettingsTitleRect.yMax, gizmoSettingsGroup.width, numberOfGizmoSettingCheckboxes * spaceBetweenCheckBoxes);
        ...
        private void DoGeneralSettingsGroup(Rect generalSettingsRect)
        {
            ...
            Text.Font = GameFont.Medium;
            Rect generalSettingsTitleRect = new(0, 0, generalSettingsRect.width, Text.LineHeight);
            Widgets.Label(generalSettingsTitleRect, "RR_Mtw_GeneralSettings_Title".Translate());

            Text.Font = GameFont.Small;

            Rect generalSettingsCheckboxesRect = new(0, generalSettingsTitleRect.yMax, generalSettingsRect.width, 300);
            int jndex = 0;
            CheckboxLabeled(new Rect
            {
                x = 0,
        ...
        private void DoExemptionSettingsGroup(Rect exemptionSettingsGroup)
        {
            ...
            Text.Font = GameFont.Medium;
            Rect exemptionSettingsTitleRect = new(0, 0, exemptionSettingsGroup.width, Text.LineHeight);
            Widgets.Label(exemptionSettingsTitleRect, "RR_Mtw_BodyChangeExemptionSettingsTitle".Translate());

            Text.Font = GameFont.Small;

            Rect exemptionSettingsCheckBoxesRect = new(0, exemptionSettingsTitleRect.yMax, exemptionSettingsGroup.width, numberOfExemptionSettingsCheckboxes * spaceBetweenCheckBoxes);
        ...
        private void DoGlobalMultpliersSettingsGroup(Rect globalMultipliersSettingsGroup)
        {
            ...
            //Category Title
            Text.Font = GameFont.Medium;
            Rect globalMultipliersSettingsTitleRect = new(0, 0, globalMultipliersSettingsGroup.width, Text.LineHeight);
        ...
        private void DoMainSettingsTitleGroup(Rect titleRect)
        {
            if (Prefs.DevMode)
            {
                Rect metaRect = new(titleRect.x + (titleRect.width / 4), titleRect.y, titleRect.width / 5, Text.LineHeight);
                Widgets.TextFieldNumericLabeled<float>(metaRect, "Meta field 1 ", ref _metaFloat, ref _metaStrBuffer);

                Rect metaRect2 = new(titleRect.x + (titleRect.width / 2), titleRect.y, titleRect.width / 5, Text.LineHeight);
                Widgets.TextFieldNumericLabeled<float>(metaRect2, "Meta field 2 ", ref _metaFloat2, ref _metaStrBuffer2);

                Rect metaRect3 = new(titleRect.x + (0.75f * titleRect.width), titleRect.y, titleRect.width / 5, Text.LineHeight);
        ...
        private void DoNutritionSettingsGroup(Rect nutritionSettingsGroup)
        {
            ...
            //Category Title
            Text.Font = GameFont.Medium;
            Rect mapNutritionTitleRect = new(0, 0, nutritionSettingsGroup.width, Text.LineHeight);
            ...
            Rect rectMapNutContent = new(0, mapNutritionTitleRect.yMax, nutritionSettingsGroup.width, 6 * Text.LineHeight);
            ...
            Rect nutritionPerPawnLabel = new(0, rectMapNutContent.yMax, nutritionSettingsGroup.width, Text.LineHeight);
        ...
        {
            NutritionTable nutritionTable = new();
        ...
        static Dictionary<string, int> titleToIDpair = new();
            ...
            Rect categoryRect, ref NumericFieldData<T> numericFieldData, int positionNumberInList, string translationLabel , GameFont font = GameFont.Small, SwitchActionCallback action = null, String descriptionTextTag = null) where T : struct
        {
            ...
            Text.Font = font;
            Rect boundingRect = new(0, categoryRect.y + positionNumberInList * spaceBetweenNumberFields, categoryRect.width - numberFieldRightOffset, Text.LineHeight);
