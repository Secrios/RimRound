...
namespace RimRound.UI
{
    public static class WeightGizmo_DeathWarning
    {
        ...
        {
            DiaNode diaNode = new("FullnessDeathWarningExplanation".Translate(pawn.Name.ToStringShort));

            DiaOption diaOption1 = new("FullnessDeathWarningKill".Translate());
            ...
            DiaOption diaOption2 = new("FullnessDeathWarningCancel".Translate());
            ...
            Dialog_NodeTree dialog_NodeTree = new(diaNode, true, false, "FullnessDeathWarningTitle".Translate());
