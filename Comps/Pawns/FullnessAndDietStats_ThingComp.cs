...
namespace RimRound.Comps
{
    public class FullnessAndDietStats_ThingComp : ThingComp
    {
        ...
        private List<string> _perkNamesForSaving = new();
        private List<int> _perkLevelValuesForSaving = new();
        ...
        public void RuptureStomach()
        {
            ...
            while (remainingDamage > 0)
            {
                ...
                DamageInfo stomachRuptureDamageInfo = new(
        ...
        public RimRoundStatBonuses statBonuses = new();

        public Queue<WeightGainRequest> activeWeightGainRequests = new();
        public Queue<WeightGainRequest> activeWeightLossRequests = new();

        public PerkLevels perkLevels = new();
        ...
        public static Vector2 softLimitVariation = new(-0.10f, 0.50f);
