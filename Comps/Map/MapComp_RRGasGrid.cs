...
namespace RimRound.Comps
{
    public class MapComp_RRGasGrid : MapComponent, IExposable
    {
        ...
        private static Dictionary<RRGasType, byte> gasDissipationRate = new()
        {
            { RRGasType.fatteningGas, 4},
        };

        private static Dictionary<RRGasType, Color> gasToColor = new()
        {
            { RRGasType.fatteningGas, new Color(1, 1, 1, byte.MaxValue) },
        };

        private static readonly FloatRange AlphaRange = new(0.2f, 0.8f);
        ...
        public void EqualizeGasThroughBuilding(Building b, bool twoWay)
        {
            ...
            List<Pair<RRGasType, float>> gasAndTotalAmount = new();
