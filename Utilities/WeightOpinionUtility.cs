...
namespace RimRound.Utilities
{
    public static class WeightOpinionUtility
    {
        ...
        public static Dictionary<WeightOpinion, TraitDef> weightOpinionToTraitDef = new()
        {
        ...
        public static Dictionary<WeightOpinion, ThoughtDef> weightOpinionToThoughtDef = new()
        {
        ...
        public static Dictionary<TraitDef, float> traitAndCommonalityPair = new()
        {
        ...
        /// </summary>
        public static Dictionary<float, int> severityToThoughtIndex = new()
        {
            { 0.010f,  0  },
            { 0.020f,  1  },
            { 0.035f,  2  },
        ...
        public static List<Pair<WeightOpinion, float>> reluctanceGap = new()
            {
        ...
        public static Dictionary<WeightOpinion, float> weightOpinionToGainResistance = new()
            {
        ...
        public static Dictionary<WeightOpinion, float> weightOpinionToLossResistance = new()
            {
