...
namespace RimRound.Utilities
{
    ...
    public static class Perks
    {
        ...
        public static List<Perk> basicPerks = new()
        {
            ...
            (FullnessAndDietStats_ThingComp p, Perks.Perk perk) =>
            {
                if (p.perkLevels.availablePoints >= perk.cost)
                {
                    ...
                    Utilities.HediffUtility.AddHediffSeverity(Defs.HediffDefOf.RimRound_Weight, pawn, Utilities.HediffUtility.KilosToSeverityWithoutBaseWeight(5));
                }
            },
            (FullnessAndDietStats_ThingComp p, Perks.Perk perk) =>
            {
        ...
        public static List<Perk> advancedPerks = new()
        {
            ...
            new Perk("RR_TheresTheBeef_Title", "RR_TheresTheBeef_Desc", 5, 1, theresTheBeefIcon,
            (FullnessAndDietStats_ThingComp p, Perks.Perk perk) =>
            {
                if (p.perkLevels.availablePoints >= perk.cost)
                {
        ...
        public static List<Perk> elitePerks = new()
        {
        ...
        public static List<Perk> ultimatePerks = new()
        {
            ...
            (FullnessAndDietStats_ThingComp p, Perks.Perk perk) =>
            {
                ...
                // Perk requirements
                StringBuilder failureDescription = new();
            ...
            (FullnessAndDietStats_ThingComp p, Perks.Perk perk) =>
            {
                if (p.perkLevels.availablePoints >= perk.cost)
                {
                    ...
                    Pawn pawn = p.parent.AsPawn();
                    Utilities.HediffUtility.AddHediffSeverity(Defs.HediffDefOf.RimRound_Weight, pawn, Utilities.HediffUtility.KilosToSeverityWithoutBaseWeight(500));
        ...
        public static List<Perk> abilities = new()
        {
