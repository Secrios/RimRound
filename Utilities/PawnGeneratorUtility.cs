...
namespace RimRound.Utilities
{
    public static class PawnGeneratorUtility
    {
        ...
        //Percentiles/Weight
        static List<Pair<float, float>> playerFactionWeightDistribution = new()
        {
        ...
        static List<Pair<float, float>> hostileFactionWeightDistribution = new()
        {
        ...
        static List<Pair<float, float>> friendlyFactionWeightPercentiles = new()
        {
