...
namespace RimRound.FeedingTube
{
    public class FoodNet
    {
        ...
        public List<FoodNetStorage_ThingComp> foodNetStorages = new();
        public List<FoodNetTrader_ThingComp> foodNetTrader = new();
        public List<FoodTransmitter_ThingComp> foodTransmitters = new();
