...
namespace RimRound.FeedingTube
{
    ...
    public class Building_FoodVatLarge : Building
    {
        ...
        public override void Draw()
        {
            ...
            r.filledMat = Building_FoodVatLarge.StorageBarFilledMat;
            r.unfilledMat = Building_FoodVatLarge.StorageBarUnfilledMat;
            r.margin = 0.05f;
