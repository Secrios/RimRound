...
namespace RimRound.FeedingTube
{
    public class FoodTransmitter_NetManager : MapComponent
    {
        ...
        public void Notify_ConnectorAdded(FoodTransmitter_ThingComp comp) 
        {
            ...
            List<FoodTransmitter_ThingComp> neighbors = new();
        ...
        {
            List<List<FoodTransmitter_ThingComp>> foodNetsComps = new();
            ...
            while (compsToProcess.Count > 0)
            {
                ...
                Queue<FoodTransmitter_ThingComp> queue = new();
                List<FoodTransmitter_ThingComp> neighbors = new();
                ...
                while (queue.Count > 0)
                {
                    ...
                    List<FoodTransmitter_ThingComp> listOfNeighboringComps = new();
            ...
            List<FoodNet> listOfFoodNets = new();
        ...
        public List<FoodNet> FoodNets = new();
    }
}
